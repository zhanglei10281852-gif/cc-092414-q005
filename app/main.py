...
from app.trace.service import ensure_schema as ensure_trace_schema
...
app = FastAPI(title="餐桌安全食品追溯服务", version="2.0.0", lifespan=lifespan)
...
@app.get("/")
def root() -> dict:
    return {"service": "餐桌安全食品追溯服务", "version": "2.0.0"}
